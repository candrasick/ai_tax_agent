...
from chromadb.api.types import EmbeddingFunction # Added for wrapper
...
def get_embedding_function(model_name: str = "models/text-embedding-004", task_type: str = "retrieval_document") -> LangchainEmbeddingFunctionWrapper | None:
    """Initializes the Langchain embedder and returns it wrapped for ChromaDB.
    ...
    if not settings.gemini_api_key:
        ...
        return None
    try:
        # Create the LangChain embedding function instance
        ...
        # Return the wrapped instance for ChromaDB compatibility
